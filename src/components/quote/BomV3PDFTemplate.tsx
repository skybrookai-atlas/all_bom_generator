  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.brandPrimary}>{DEFAULT_BRAND.companyName}</Text>
            <Text style={s.brandSecond}>
              {DEFAULT_BRAND.tagline} — {DEFAULT_BRAND.website}
            </Text>
          </View>
        ...
        {/* Footer */}
        <Text style={s.footer}>
          {DEFAULT_BRAND.companyName} · {DEFAULT_BRAND.website} · All prices ex-GST unless noted
        </Text>
      </Page>
    </Document>
  );
